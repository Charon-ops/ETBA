...
model_config = {
    ...
    "loss_type": "BCE",    # 损失函数类型, multi-class:  可选 None(BCE), BCE, BCE_LOGITS, MSE, FOCAL_LOSS, DICE_LOSS,
    # LABEL_SMOOTH, MIX; multi-label:  SOFT_MARGIN_LOSS, PRIOR_MARGIN_LOSS, FOCAL_LOSS, CIRCLE_LOSS, DICE_LOSS, MIX等

    "batch_size": 16,  # 批尺寸
    "num_labels": 2,  # 类别数, 自动更新
    ...
    "save_best_mertics_key": ["weighted_avg", "recall"],  # 模型存储的判别指标, index-1可选: [micro_avg, macro_avg, weighted_avg],
